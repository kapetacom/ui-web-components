...
export const HtmlCanDragAndDropIntoDifferentZones = () => (
...
HtmlCanDragAndDropIntoDifferentZones.story = {
    name: 'HTML: Can drag and drop into different zones',
};

export const HtmlCanDragAndDropIntoScrollableBigZone = () => (
    <div className={'container'}>
        <div className={'dnd-container'}>
            <DnDContainer overflowX={true} overflowY={true}>
                <div>
...
HtmlCanDragAndDropIntoScrollableBigZone.story = {
    name: 'HTML: Can drag and drop into scrollable big zone',
};

export const HtmlCanMoveDraggableWithinDroppableZone = () => {
    return (
        <div className={'container'}>
            <div className={'dnd-container'}>
                <DnDContainer overflowX={true} overflowY={true}>
...
HtmlCanMoveDraggableWithinDroppableZone.story = {
    name: 'HTML: Can move draggable within droppable zone',
};

export const SvgCanDragAndDropIntoDifferentZones = () => (
    <div className={'container'}>
        <div className={'dnd-container'}>
            <DnDContainer overflowX={true} overflowY={true}>
                <div>
...
SvgCanDragAndDropIntoDifferentZones.story = {
    name: 'SVG: Can drag and drop into different zones',
};

export const SvgCanMoveDraggableWithinDroppableZoneZoom05 = () => (
    <div className={'container'}>
        <div className={'dnd-container'}>
...
SvgCanMoveDraggableWithinDroppableZoneZoom05.story = {
    name: 'SVG: Can move draggable within droppable zone (Zoom 0.5)',
};

export const SvgCanMoveDraggableSvgGroupZoom2 = () => (
    <div className={'container'}>
        <div className={'dnd-container'}>
...
SvgCanMoveDraggableSvgGroupZoom2.story = {
    name: 'SVG: Can move draggable SVG group (Zoom 2)',
};
