...
export const IconButtons = () => {
    return (
        <div style={{ padding: '20px'}}>
            ...
            <Button shape={ButtonShape.ICON} style={ButtonStyle.PRIMARY_SHINE} width={ButtonSize.ICON} text={'fad fa-eye'} />
            <br /><br />
...
export const SquareButtons = () => {
    return (
        <div style={{ padding: '20px'}}>
            ...
            <Button shape={ButtonShape.SQUARE} style={ButtonStyle.PRIMARY_SHINE} width={ButtonSize.SMALL} text={'Save'} />
            <br /><br />
