...
const gcpIcon: IconValue = {type: IconType.URL, value: 'https://storage.googleapis.com/kapeta-public-cdn/icons/gcp.svg'};

const PLAN:Kind = {kind: 'core/plan', metadata: {name:'kapeta/my-plan', title:'My Plan'}, spec: {}};
const BLOCK_TYPE:Kind = {kind: 'core/block-type', metadata: {name:'kapeta/my-block-type', title:'Frontend'}, spec: {
    icon: desktopIcon
}};
const BLOCK_TYPE_OPERATOR:Kind = {kind: 'core/block-type-operator', metadata: {name:'kapeta/my-block-operator', title:'Gateway'}, spec: {}};

const RESOURCE_TYPE_INTERNAL:Kind = {kind: 'core/resource-type-internal', metadata: {name:'kapeta/my-resource-type', title:'REST API'}, spec: {}};
const RESOURCE_TYPE_OPERATOR:Kind = {kind: 'core/resource-type-operator', metadata: {name:'kapeta/my-resource-type', title:'MongoDB'}, spec: {
    icon: dbIcon
}};
const RESOURCE_TYPE_EXTENSION:Kind = {kind: 'core/resource-type-extension', metadata: {name:'kapeta/my-resource-type', title:'Payment'}, spec: {}};

const LANGUAGE_TARGET:Kind = {kind: 'core/language-target', metadata: {name:'kapeta/my-lang-type', title:'Javascript'}, spec: {
    icon: jsIcon
}};
const DEPLOYMENT_TARGET:Kind = {kind: 'core/deployment-target', metadata: {name:'kapeta/my-deploy-type', title:'GCP'}, spec: {
    icon: gcpIcon
}};
