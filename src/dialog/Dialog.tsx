    ...
    implements OverlayComponent
{
    ...
    private renderDeleteDialog = (initialSize: DialogSize) => {
        return (
            <svg
                className={'dialog-shape'}
                width={initialSize.width}
                height={initialSize.height}
                viewBox={'0 0 ' + initialSize.height + ' ' + initialSize.height}
            >
