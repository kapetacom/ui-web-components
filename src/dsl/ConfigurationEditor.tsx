...
function fieldValidator(entity: PEGValidationEntity<DSLDataTypeProperty>) {
    ...
    if (property.defaultValue) {
        if (property.defaultValue.type === 'literal' &&
            ...
            } else  if (['integer','float','double','number','bigint'].includes(property.type) && typeof property.defaultValue.value !== 'number') {
            ...
            if (!isBuiltInType(property as TypeLike)) {
                if (typeof property.defaultValue.value !== 'string' ||
        ...
        } else if (property.defaultValue.type === 'reference' &&
