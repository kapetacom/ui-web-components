...
const AlertIcon: React.FC = () => (
    <svg width="42" height="42" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path
            d="M14.0312 8.03029C14.0141 7.4664 14.4666 7 15.0308 7H16.9692C17.5334 7 17.9859 7.4664 17.9688 8.03029L17.6961 17.0303C17.6797 17.5705 17.237 18 16.6965 18H15.3035C14.763 18 14.3203 17.5705 14.3039 17.0303L14.0312 8.03029Z"
            fill="white"
        />
    </svg>
);
