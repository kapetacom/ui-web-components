    ...
    render() {
        ...
        return (
            <div className={classFormElemContainer} >
                <span className={classNameLabel} >{this.uppercaseFirstLetter(this.props.label)}</span>
                ...
                {(this.props.inputStatus === "warning" || this.props.inputStatus === "error") &&
                    <>
                        {this.props.inputMode === "singleline" &&
                            <svg className={classNameStatusIcon} width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
