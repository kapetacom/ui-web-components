    ...
    render() {
        ...
        return (
            <div className={classFormElemContainer} >
                ...
                {( this.props.status === StatusType.WARNING || this.props.status === StatusType.ERROR) && this.props.infoBox &&
