...
export class FormElementContainer extends React.Component<Props> {
        ...
        return (
            ...
            >
                <path
                    ...
                    fill={
                        this.props.status === StatusType.WARNING
                            ? '#FCC024'
                            : '#E35A4C'
                    }
                />
    ...
    render() {
        const showStatusIcon =
            this.props.touched && this.props.status !== StatusType.OK;
        ...
        let classFormElemContainer = toClass({
            ...
            required:
                ...
                this.props.touched,
            'warning-status':
                !this.props.focused && this.props.status === StatusType.WARNING,
            'error-status':
                !this.props.focused && this.props.status === StatusType.ERROR,
            ['type-' + inputType]: true,
        });
        ...
        const helpMessage =
            this.props.errorMessage && this.props.touched
