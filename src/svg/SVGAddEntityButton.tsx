        ...
        <div style={addFieldButtonStyle}>
            ...
            <div className={"add-button-wrapper"}>
                ...
                <svg style={plusHexStyle} width="26" height="22" viewBox="16 0 26 22" fill="none">
                    ...
                    <svg width="24" height="24" viewBox="-7 -5 26 26" fill="none" >
                        <path d="M12.3145 6.65686L1.00144 6.65756" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                        <path d="M6.65723 1L6.65653 12.313" stroke="white" strokeWidth="1.5" strokeLinecap="round" />
                    </svg>
                </svg>
            </div>
        </div>
